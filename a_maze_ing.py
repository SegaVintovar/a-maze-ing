...
def get_directions(maze: Maze) -> str:
    ...
    next_cell: Cell = None
    print("get dir")
    while next_cell.position != maze.exit:
        dir, next_cell = get_right_dir(current, maze)
        # print(right_dir)
